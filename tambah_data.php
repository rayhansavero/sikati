...
<head>
    ...
    <title>Kas Rutin | SI Keuangan HMJ TI</title>
    <!-- Favicon-->
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            <li class="active">
                                <a href="kas_rutin.html">List Data Kas Rutin</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="#">Daftar Laba Kewirausahaan</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                             ...
                             <h2 class="card-inside-title">Tambah Data</h2><br/>
